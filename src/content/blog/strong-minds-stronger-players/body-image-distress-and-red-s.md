...
Female athletes live in a particular kind of body conversation. Comments about weight, build, kit fit, what looks "strong" or "lean," what an athlete is "supposed to" look like. Some of that is normal noise, and most athletes navigate around it. Some of it is harmful, and a portion of female athletes will develop a relationship with food and body that needs clinical care.

This is one of the most under-discussed areas in women's sport, so it is worth being direct about the warning signs.

## What this can look like

- Skipping meals, eating much less than the energy you are expending.
- Compulsive checking: weighing, mirror-checking, comparing yourself in photos.
- Anxiety around food, especially in social or team eating settings.
- Loss of menstrual periods (a critical warning sign, see RED-S below).
- Recurrent stress fractures or injuries that take a long time to heal.
...
- Talk to your doctor. RED-S and eating disorders both need medical assessment.
- Get a sports dietitian if available. Many GAA and LGFA county set-ups have one.

...
Most athletes go over a mistake in their head after a match. The wide shot. The missed tackle. The pass that did not come off. A short replay is normal, and sometimes useful.

What is not normal is when the replay does not stop. When you are still up at two in the morning running the same five seconds of a game on a loop. When the mistake stops being about football and starts becoming a story about who you are. That loop is called rumination, and when it is paired with shame it can become heavy enough to need outside support.

## What this can look like

- Going over the same moment in your head for hours or days.
- Feeling like a mistake says something about you as a person, not just your performance.
- Avoiding people on your team because you feel embarrassed.
...
- Set a "worry window". Give yourself 10 minutes to think the thought through fully, then move. Walk, train, call someone. The window prevents the loop from running all day.
...
- **Your GP** is the first stop if rumination is affecting sleep, mood, or daily life.
- **NHS Talking Therapies (UK)**: CBT is particularly effective for rumination patterns.
- **HSE Mental Health Services (Ireland)**: via GP referral.
- **Mind (UK)** at mind.org.uk for understanding the link between rumination and low mood.
